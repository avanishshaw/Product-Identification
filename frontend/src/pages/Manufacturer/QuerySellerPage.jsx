...
const dummySellers = [
    { _id: '1', sellerId: 'S001', sellerName: 'ElectroHub', sellerBrand: 'Gadgetron', sellerCode: 'EHUB1', sellerNum: '123-456-7890', sellerManager: 'John Doe', sellerAddress: '123 Tech Lane, Silicon Valley' },
    { _id: '2', sellerId: 'S002', sellerName: 'Digital Dreams', sellerBrand: 'NextGen', sellerCode: 'DDREAMS', sellerNum: '098-765-4321', sellerManager: 'Jane Smith', sellerAddress: '456 Circuit Ave, Tech City' },
];
  ...
  return (
    <div className="form-card">
      ...
      <div className="table-wrapper">
        ...
        {sellers.length === 0 && <p className="p-4 text-center text-slate-500">No sellers to display. Enter a code and search.</p>}
      </div>
    </div>
  );
};
